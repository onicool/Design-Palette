...
const particleEarthScript = String.raw`import * as THREE from 'https://unpkg.com/three@0.128.0/build/three.module.js';
...
const config = {
  particleCount: (() => {
    ...
    if (width >= 1280) return 9000;
    if (width >= 768) return 5200;
    return 2600;
  })(),
  rotationSpeed: 0.001,
  particleSize: 2,
...
function main() {
  ...
  glowMaterial.size = material.size * 2;
  glowMaterial.opacity = 0.25;
  ...
  const page = html`<!DOCTYPE html>
    <html lang="ja">
      ...
      <body>
        ...
        <script type="module">${particleEarthScript}</script>
      </body>
    </html>`
